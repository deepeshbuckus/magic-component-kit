...
export const CustomStyles: Story = {
  render: () => html`
    <div style="display: flex; flex-wrap: wrap; gap: 0.75rem;">
      <ds-category-pill color="hsl(200, 100%, 50%)">Blue Pill</ds-category-pill>
      <ds-category-pill color="hsl(150, 60%, 45%)">Green Pill</ds-category-pill>
      <ds-category-pill border="2px solid hsl(280, 70%, 55%)">Purple Border</ds-category-pill>
      <ds-category-pill borderRadius="20px">Rounded</ds-category-pill>
      <ds-category-pill 
        color="hsl(30, 100%, 50%)"
        borderRadius="8px"
      >
